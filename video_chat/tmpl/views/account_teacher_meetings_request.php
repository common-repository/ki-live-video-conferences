		...
		<?php 
			...
			<div class="row-appointment">
				...
				<div class="room-buttons">
					<a href="/account/?ki_vc_room=add_room&teacher=<?php echo $Doctor;?>&appointment=<?php echo $post_id;?>" class="ki-but"><?php esc_html_e( 'Meeting requests', 'ki-live-video-conferences' );?></a>
				</div>
			</div>
			<?php
