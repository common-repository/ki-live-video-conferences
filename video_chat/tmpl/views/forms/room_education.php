...
$doctor_id=KiFunctions::v_get('teacher');
...
if(intval($RoomID)>0){//Edit Room
	...
	$FiledsValue['doctors']=get_post_meta( $RoomID,'teachers', true );
	$FiledsValue['patients']=get_post_meta( $RoomID,'students', true );
...
<div class="ki-live-video-conferences">
	...
	<div class="ki-live-video-conferences-Room">
		...
		<table border="0">
			...
			<tr>
				<td><?php esc_attr_e( 'Teacher', 'ki-live-video-conferences' ); ?><td>
				<td><?php echo $doctor->display_name;?> <input type="hidden" name="teacher_id" value="<?php echo $doctor_id;?>"><td>
			</tr>
			<tr>
				<td><?php esc_attr_e( 'Student', 'ki-live-video-conferences' ); ?><td>
				<td>
					<select name ="students">
						<?php
						$patients=get_users(Array('role'=>'student'));
