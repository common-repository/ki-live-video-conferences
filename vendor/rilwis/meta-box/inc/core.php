...
class RWMB_Core {
	...
	public function plugin_links( $links ) {
		$links[] = '<a href="https://docs.metabox.io">' . esc_html__( 'Documentation','ki-live-video-conferences') . '</a>';
		$links[] = '<a href="https://metabox.io/plugins/" style="color: #39b54a; font-weight: bold">' . esc_html__( 'Extensions','ki-live-video-conferences') . '</a>';
		return $links;
	}
