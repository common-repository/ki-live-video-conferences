...
class RWMB_About {
	...
	public function plugin_links( $links ) {
		$links[] = '<a href="' . esc_url( $this->get_menu_link() ) . '">' . esc_html__( 'About','ki-live-video-conferences') . '</a>';
		return $links;
	}
	...
	public function add_menu() {
		...
		add_menu_page(
			__( 'Meta Box','ki-live-video-conferences'),
			__( 'Meta Box','ki-live-video-conferences'),
			'activate_plugins',
			'meta-box',
			'__return_null',
	...
	public function add_submenu() {
		...
		$about       = add_submenu_page(
			$parent_menu,
			__( 'Welcome to Meta Box','ki-live-video-conferences'),
			__( 'Dashboard','ki-live-video-conferences'),
			'activate_plugins',
			'meta-box',
			array( $this, 'render' )
		);
	...
	public function hide_page() {
		remove_submenu_page( $this->get_parent_menu(),'ki-live-video-conferences');
	}
	...
	public function change_footer_text() {
		...
		echo wp_kses( sprintf( __( 'Please rate <strong>Meta Box</strong> <a href="%1$s" target="_blank">&#9733;&#9733;&#9733;&#9733;&#9733;</a> on <a href="%1$s" target="_blank">WordPress.org</a> to help us spread the word. Thank you from the Meta Box team!','ki-live-video-conferences'), 'https://wordpress.org/support/view/plugin-reviews/meta-box?filter=5#new-post' ), $allowed_html );
	}
