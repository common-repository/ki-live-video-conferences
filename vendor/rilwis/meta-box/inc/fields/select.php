...
class RWMB_Select_Field extends RWMB_Choice_Field {
	...
	public static function get_select_all_html( $field ) {
		if ( $field['multiple'] && $field['select_all_none'] ) {
			return '<div class="rwmb-select-all-none">' . __( 'Select','ki-live-video-conferences') . ': <a data-type="all" href="#">' . __( 'All','ki-live-video-conferences') . '</a> | <a data-type="none" href="#">' . __( 'None','ki-live-video-conferences') . '</a></div>';
		}
		return '';
	}
}
