...
class RWMB_File_Field extends RWMB_Field {
	...
	public static function admin_enqueue_scripts() {
		...
		RWMB_Helpers_Field::localize_script_once(
			...
			array(
				...
				'maxFileUploadsSingle' => __( 'You may only upload maximum %d file','ki-live-video-conferences'),
				// Translators: %d is the number of files in plural form.
				'maxFileUploadsPlural' => __( 'You may only upload maximum %d files','ki-live-video-conferences'),
			)
		);
	}
	...
	public static function ajax_delete_file() {
		...
		if ( ! in_array( $attachment, $field_value ) ) {
			wp_send_json_error( __( 'Error: Invalid file','ki-live-video-conferences') );
		}
		...
		wp_send_json_error( __( 'Error: Cannot delete file','ki-live-video-conferences') );
	}
	...
	public static function html( $meta, $field ) {
		...
		$i18n_more = apply_filters( 'rwmb_file_add_string', _x( '+ Add new file', 'file upload','ki-live-video-conferences'), $field );
	...
	protected static function file_html( $file, $index, $field ) {
		$i18n_delete = apply_filters( 'rwmb_file_delete_string', _x( 'Delete', 'file upload','ki-live-video-conferences') );
		$i18n_edit   = apply_filters( 'rwmb_file_edit_string', _x( 'Edit', 'file upload','ki-live-video-conferences') );
